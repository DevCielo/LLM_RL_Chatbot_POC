...
class DetailsAgent():
    ...
    def get_response(self, messages):
        ...
        system_prompt = """ 
        You are a customer support agent for a Barcelona soccer store.
        You should answer every question as if you are a customer support agent for a Barcelona soccer store and provide
        the necessary information to the user regarding the orders.
        """
