...
class RecommendationAgent():
    ...
    def recommendation_classification(self, message):
        system_prompt = """ You are a helpful AI assistant for a Barcelona soccer shop application which sells like shirts and socks and pants etc. We have 3 types of recommendations:
        ...
        2. Popular Recommendations: These are recommendations based on the popularity of items in the soccer shop. We recommend items that are popular among customers.
        3. Popular Recommendations by Category: Here the user asks to recommend them product in a category. Like what socks do you recommend me to get?. We recommend items that are popular in the category of the user's requested category.
        
        Here is the list of items in the soccer shop:
        """+ ",".join(self.products) + """
        Here is the list of Categories we have in the soccer shop:
    ...
    def get_recommendations_from_order(self, messages, order):
        ...
        system_prompt = f"""
        You are a helpful AI assistant for a soccer shop application which sells like shirts and socks and pants etc.
