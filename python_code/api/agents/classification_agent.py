...
class ClassificationAgent():
    ...
    def get_response(self, messages):
        ...
        system_prompt = """
            You are a helpful AI assistant for a Barcelona soccer store shop application.
            Your task is to determine what agent should handle the user input. You have 3 agents to choose from:
            1. details_agent: This agent is responsible for answering questions about the soccer shop, like location, delivery places, working hours, details about menue items. Or listing items in the menu items. Or by asking what we have.
